...
#include <ar_general_purpose/xlcsv/brdb.h>

#pragma pack(1)

#if 0
// Note that this function is ifdeffed out below...
static void xls_showBOUNDSHEET(void* bsheet);
#endif

void dumpbuf( const char* fname,long size,XLSBYTE* buf)
{
...
XLSDWORD xls_getColor(const XLSWORD color,XLSWORD def)
{
    int cor=8;
    int size = 64 - cor;
    int max = size;
...
char*  xls_getfcell(xlsWorkBook* pWB,struct st_cell_data* cell)
{
    ...
    case 0x0FD:
        ...
        break;
    case 0x201:
        ret[0]=0; // Eliminates -Wformat-zero-length warning
        //sprintf(ret,"");
        break;
    case 0x0BE:
        ret[0]=0; // Eliminates -Wformat-zero-length warning
...
char* xls_getCSS(xlsWorkBook* pWB)
{
    ...
    for (i=0;i<pWB->xfs.count;i++)
    {
        ...
        {
        case 0:
            borderleft[0]=0; // Eliminates -Wformat-contains-nul warning
        ...
        {
        case 0:
            borderright[0]=0; // Eliminates -Wformat-contains-nul warning
        ...
        {
        case 0:
            bordertop[0]=0; // Eliminates -Wformat-contains-nul warning
            //sprintf(bordertop,"\0");
            break;
        default:
        ...
        {
        case 0:
            borderbottom[0]=0; // Eliminates -Wformat-contains-nul warning
        ...
        if (xf->font)
            ...
            color[0]=0; // Eliminates -Wformat-contains-nul warning
            //sprintf(color,"\0");
        }
        ...
        if (xf->font && (pWB->fonts.font[xf->font-1].flag & 2))
            ...
            italic[0]=0; // Eliminates -Wformat-contains-nul warning
            //sprintf(italic,"\0");
        }
        ...
        if (xf->font && (pWB->fonts.font[xf->font-1].bold>400))
            ...
            bold[0]=0; // Eliminates -Wformat-contains-nul warning
            //sprintf(bold,"\0");
        }
        ...
        if (xf->font && (pWB->fonts.font[xf->font-1].underline))
            ...
            underline[0]=0; // Eliminates -Wformat-contains-nul warning
            //sprintf(underline,"\0");
        }
        ...
        background=xls_getColor((XLSWORD)(xf->groundcolor & 0x7f),1);
