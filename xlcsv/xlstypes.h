...
typedef unsigned char		XLSBYTE;//  __attribute__ ((aligned (1)));	// 1 bytes
typedef uint16_t			XLSWORD;// __attribute__ ((aligned (1)));	// 2 bytes
typedef uint32_t			XLSDWORD;//  __attribute__ ((aligned (1)));	// 4 bytes
